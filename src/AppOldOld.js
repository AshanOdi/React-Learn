        ...
        <input
          ...
          onChange={(e) => {
            ...
            setInputData((preInputData) => {
              return { ...preInputData, imgUrl: e.target.value };
            });
          }}
        />
        <input
          ...
          onChange={(e) => {
            e.preventDefault();
            setInputData((preInputData) => {
              return { ...preInputData, name: e.target.value };
            });
          }}
        />
        <input
          ...
          onChange={(e) => {
            e.preventDefault();
            setInputData((preInputData) => {
              return { ...preInputData, city: e.target.value };
            });
          }}
        />
        <input
          ...
          onChange={(e) => {
            e.preventDefault();
            setInputData((preInputData) => {
              return { ...preInputData, position: e.target.value };
            });
          }}
        />
        <button
